...
const normalization_json_1 = __importDefault(require("../resources/normalization.json"));
const mcc_risk_json_1 = __importDefault(require("../resources/mcc_risk.json"));
...
function DiaDaSemana(timestamp) {
    return new Date(timestamp).getUTCDay() / 6.0;
}
function minutosDesdeUltima(timestamp, requestAt) {
...
function normalizar(payload) {
    ...
    const n = normalization_json_1.default;
    return [
        //0 - amount
        ...
        //12 - mcc_risk
        mcc_risk_json_1.default[merchant.mcc] ?? 0.5,
